...
public class CircleSeekBar extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int progressColor = ContextCompat.getColor(context, R.color.circular_progress_bar_color);
        int arcColor = ContextCompat.getColor(context, R.color.transparent);
        int textColor = ContextCompat.getColor(context, R.color.transparent);
        mProgressWidth = (int) (density * mProgressWidth);
        mArcWidth = (int) (density * mArcWidth);
        mTextSize = (int) (density * mTextSize);

        mThumbDrawable = ContextCompat.getDrawable(context, R.drawable.circle);
        if (attrs != null) {
...
//        mThumbDrawable.setBounds(mThumbX - mThumbSize / 2, mThumbY - mThumbSize / 2, mThumbX + mThumbSize / 2, mThumbY + mThumbSize / 2);
        mThumbDrawable.setBounds(0, 0, 0, 0);
